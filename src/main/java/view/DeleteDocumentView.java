...
public class DeleteDocumentView {
    ...
    private void initialize() {
        ...
        confirmButton.addActionListener(a-> {adminController.deleteDocument(comboBox.getSelectedItem().toString());
